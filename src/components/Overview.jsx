      ...
      <div className="flex border-spacing-1 pt-20">
        <div className="left bg-zinc-600 w-1/4 h-screen ">
          ...
          {/* <div className="content ">
            {["Go to Gym", "Rise @6", "Sleep @12", "Anything Else"].map(
              (todo, index) => (
                <ul className="flex">
                  <li
                    className="m-3 p-1.5 w-3/5  items-center text-center border-solid border-2 border-black rounded flex justify-between"
                    key={index}
                  >
                    {todo}
                    <svg
